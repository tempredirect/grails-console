...
<body>   
   ...
   <div id="header">        
      <div class="plugin-info">
         Grails Console Plugin ${applicationContext.pluginManager.getGrailsPlugin("console").version}<br />
         <span class="authors">by Siegfried Puchbauer and Mingfai Ma</span>
      </div>
